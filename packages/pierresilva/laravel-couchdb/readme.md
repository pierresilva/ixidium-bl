...
```
composer require pierresilva/laravel-couchdb
```
...
```php
'default' => env('BASELINE_DB_CONNECTION', 'couchdb'),
```
...
```php
pierresilva\CouchDB\Auth\PasswordResetServiceProvider::class,
```
...
```php
use pierresilva\CouchDB\Auth\User as Authenticatable;
...
```php
pierresilva\CouchDB\CouchDBQueueServiceProvider::class,
```
Examples
--------
