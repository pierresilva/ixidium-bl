...
class CrudAngularFrontEndCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'crud:angular:frontend
                            {name : The name of the Crud.}
                            {title : String used for the title.}
    ...
    public function handle()
    {
        ...
        $angularRouteFile = File::get(base_path('resources/angular/app/app-routing.ts'));
        ...
        $angularRouteFile = str_replace("// generated " . $fileEstructure['crud_module'] . " module routes here //", $module_routing_string, $angularRouteFile);

        File::put(base_path('resources/angular/app/app-routing.ts'), $angularRouteFile);
