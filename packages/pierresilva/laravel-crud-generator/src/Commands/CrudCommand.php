...
class CrudCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->call('crud:request', ['name' => $name . 'Create', '--validations' => $validations, '--authorize' => true]);
        $this->call('crud:request', ['name' => $name . 'Edit', '--validations' => $validations, '--authorize' => true]);
        if ($localize == 'yes') {
