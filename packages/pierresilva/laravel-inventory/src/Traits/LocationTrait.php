...
use pierresilva\Inventory\Exceptions\InvalidLocationException;
...
trait LocationTrait
{
     ...
     * is an instance of the model AdmiLocation, if a numeric value is entered, it is retrieved by it's ID.
     *
     * @param $location
     *
