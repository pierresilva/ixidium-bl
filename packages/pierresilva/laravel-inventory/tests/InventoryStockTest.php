...
namespace pierresilva\Inventory\Tests;

use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Lang;
use pierresilva\Inventory\Models\Location;
use pierresilva\Inventory\Models\InventoryStock;
use pierresilva\Inventory\Models\Inventory;
...
class InventoryStockTest extends InventoryTest
{
    ...
    public function testInvalidMovementException()
    {
        ...
        $this->setExpectedException('pierresilva\Inventory\Exceptions\InvalidMovementException');
    ...
    public function testStockAlreadyExistsException()
    {
        ...
        $this->setExpectedException('pierresilva\Inventory\Exceptions\StockAlreadyExistsException');
    ...
    public function testInventoryMoveItemStock()
    {
        ...
        $locationTo->name = 'New AdmiLocation';
        $locationTo->save();
    ...
    public function testInventoryInvalidLocationException()
    {
        ...
        $this->setExpectedException('pierresilva\Inventory\Exceptions\InvalidLocationException');
    ...
    public function testInventoryStockNewTransaction()
    {
        ...
        $this->assertInstanceOf('pierresilva\Inventory\Interfaces\StateableInterface', $transaction);
    }
}
