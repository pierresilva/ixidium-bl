...
class PwaManifest extends Command
{
    ...
    {
        $manifest['lang'] = $this->ask('Enter the language', 'es-co');
        $manifest['name'] = $this->ask('Enter the name of your app', 'Renova App');
        $manifest['short_name'] = $this->ask('Enter the short name of your app', 'Renova');
        ...
        $manifest['theme_color'] = $this->ask('Enter your theme color', '#003399');
        ...
        $this->info("Manifest generated successfully.\r\nDon't forget to update your icon in public/images/icon.png");
    }
}
