...
trait SentinelTrait
{
    ...
    /**
     * The sentinel cache tag used by the user model.
     *
     * @return string
     */
    ...
    */
    ...
    {
        return $this->belongsToMany('\pierresilva\Sentinel\Models\Role')->withTimestamps();
    }
    ...
    public function assignRole($roleId = null)
    {
        ...
        if (!is_numeric($roleId)) {
            $roleId = \pierresilva\Sentinel\Models\Role::where('slug', $roleId)->pluck('id')->first();
        }
    ...
    */
    ...
    protected function getFreshPermissions()
    {
        ...
        $permissionsUnique = $permissionsCollection->unique();

        return $permissionsUnique->values()->all();
    }
