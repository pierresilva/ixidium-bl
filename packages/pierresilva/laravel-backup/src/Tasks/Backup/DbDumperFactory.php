...
use pierresilva\DbDumper\Databases\MySql;
use pierresilva\DbDumper\Databases\Sqlite;
use pierresilva\DbDumper\Databases\MongoDb;
use pierresilva\DbDumper\Databases\PostgreSql;
use pierresilva\Backup\Exceptions\CannotCreateDbDumper;
...
class DbDumperFactory
{
     ...
     *
     * @return \pierresilva\DbDumper\DbDumper
     */
    ...
    /**
     * @param \pierresilva\DbDumper\DbDumper $dbDumper
