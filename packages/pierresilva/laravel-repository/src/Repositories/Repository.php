...
use pierresilva\Repository\Contracts\Repository as RepositoryInterface;
...
abstract class Repository implements RepositoryInterface
{
    ...
    {
        /* USE WHIT REDIS, tags not allowed whit file driver
        if (method_exists(app()->make('cache')->getStore(), 'tags')) {
