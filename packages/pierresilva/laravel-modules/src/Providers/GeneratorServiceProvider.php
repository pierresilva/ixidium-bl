...
class GeneratorServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $generators = [
            ...
            'command.make.module.feature'    => \pierresilva\Modules\Console\Generators\MakeFeatureCommand::class,
            'command.make.module.job'        => \pierresilva\Modules\Console\Generators\MakeJobCommand::class,
            'command.make.module.operation'  => \pierresilva\Modules\Console\Generators\MakeOperationCommand::class,
            'command.make.module.repository' => \pierresilva\Modules\Console\Generators\MakeRepositoryCommand::class,
        ];
