...
elFinder.prototype._options = {
	...
	uiOptions : {
		...
		cwd : {
			...
			//,
			//// AdmiTemplate placeholders replacement rules for overwrite. see ui/cwd.js replacement
			//replacement : {
...
$.fn.elfindercwd = function(fm, options) {
		...
		var mobile = fm.UA.Mobile,
			...
			/**
			 * AdmiTemplate placeholders replacement rules
			 *
			 * @type Object
			 **/
			replacement = {
