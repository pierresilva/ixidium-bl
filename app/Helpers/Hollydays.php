...
class Hollydays
{
    ...
    public function festivos($ano = '')
    {
        ...
        $this->otrasFechasCalculadas(37, true);        //Ascención el Señor pascua
     ...
     *
     * @param [type] $mes_festivo
     * @param [type] $dia_festivo
     * @return void
     */
     ...
     * @return boolean
     */
    public function esFestivo($dia, $mes, $ano = null)
    {
        // echo (int)$mes;
        if ($dia == '' or $mes == '') {
            return false;
        ...
        $this->festivos = $this->festivos();

        if (isset($this->festivos[(int) $ano][(int)$mes][(int)$dia])) {
            return true;
        } else {
            return false;
        }
